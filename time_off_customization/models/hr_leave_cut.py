...
class HrLeaveCut(models.Model):
    _name = 'hr.leave.cut'
    _description = 'Hr Leave Cut'
...
Planned: Future activities.""", selection=[('overdue', 'Overdue'), ('today', 'Today'), ('planned', 'Planned')], readonly=True)
    ...
    returned_days = fields.Float(string='Returned Days', readonly=True, )
    state = fields.Selection(string='Status', selection=[('draft', 'RFQ'), ('to_approve', 'To Approve'), ('approved', 'Approved'), ('refused', 'Refused')], 
                                                default='draft', readonly=True, index=True, store=True, )
